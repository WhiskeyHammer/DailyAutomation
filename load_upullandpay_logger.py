...
async def load_with_logging():
    print("\n" + "="*70)
    print("LOADING U PULL AND PAY WITH INTERACTION LOGGER")
    print("="*70)
    print("\nSimply:")
...
"""
        ...
        try:
            ...
            # Save to file
            output_file = r"c:\Users\Whisk\OneDrive\Desktop\Code\DailyAutomation\upullandpay_interactions.json"

            with open(output_file, 'w') as f:
                json.dump({
                    "site": "U Pull and Pay",
                    "url": "https://www.upullandpay.com/inventory/search/",
